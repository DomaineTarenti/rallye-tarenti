...
async function run() {
  ...
  const objects = [
    { id: "c1000000-0001-4000-8000-000000000001", name: "La Fiole", qr_code_id: "OBJ-01", physical_id: "OBJ-01", order: 1, description: "Une petite fiole cylindrique en résine translucide", is_final: false, narrative_name: "La Fiole d'Huile Sacrée", hidden_letter: "L" },
    { id: "c1000000-0002-4000-8000-000000000002", name: "Le Fragment", qr_code_id: "OBJ-02", physical_id: "OBJ-02", order: 2, description: "Un fragment ancien en résine texturée", is_final: false, narrative_name: "Le Fragment de Mosaïque Brisée", hidden_letter: "A" },
    { id: "c1000000-0003-4000-8000-000000000003", name: "Le Sceau", qr_code_id: "OBJ-03", physical_id: "OBJ-03", order: 3, description: "Un sceau circulaire en résine avec motif gravé", is_final: false, narrative_name: "Le Sceau du Proconsul", hidden_letter: "B" },
    { id: "c1000000-0004-4000-8000-000000000004", name: "La Clé", qr_code_id: "OBJ-04", physical_id: "OBJ-04", order: 4, description: "Une grande clé ancienne en résine avec anneau décoratif", is_final: false, narrative_name: "La Clé du Sanctuaire", hidden_letter: "Y" },
    { id: "c1000000-0005-4000-8000-000000000005", name: "Le Parchemin", qr_code_id: "OBJ-05", physical_id: "OBJ-05", order: 5, description: "Un rouleau miniature en résine, comme un parchemin ancien", is_final: false, narrative_name: "Le Parchemin du Géographe", hidden_letter: "R" },
    { id: "c1000000-0006-4000-8000-000000000006", name: "L'Amulette", qr_code_id: "OBJ-06", physical_id: "OBJ-06", order: 6, description: "Une amulette ovale en résine texturée", is_final: false, narrative_name: "L'Amulette de la Déesse Tanit", hidden_letter: "I" },
    { id: "c1000000-0007-4000-8000-000000000007", name: "L'Urne", qr_code_id: "OBJ-07", physical_id: "OBJ-07", order: 7, description: "Une petite urne grecque en résine avec motifs en relief", is_final: false, narrative_name: "L'Urne des Cendres Oubliées", hidden_letter: "N" },
    { id: "c1000000-0008-4000-8000-000000000008", name: "Le Médaillon", qr_code_id: "OBJ-08", physical_id: "OBJ-08", order: 8, description: "Un médaillon circulaire en résine dorée", is_final: false, narrative_name: "Le Médaillon du Dernier Gardien", hidden_letter: "T" },
    { id: "c1000000-0009-4000-8000-000000000009", name: "Le Coffret", qr_code_id: "OBJ-09", physical_id: "OBJ-09", order: 9, description: "Un coffret ancien en résine ornementée — le trésor ultime", is_final: true, narrative_name: "Le Coffret des Secrets de Tarenti", hidden_letter: "H" },
  ];
